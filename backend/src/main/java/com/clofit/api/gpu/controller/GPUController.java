...
//    }
    ...
    ResponseEntity<BackgroundlessResponse> saveBackgroundless2(@AuthenticationPrincipal CustomOAuth2User customOAuth2User, @ModelAttribute BackgroundlessRequestDto brd) {
        ...
        gpuService.upload2(customOAuth2User.getmemberId(),BASEPATH + "/" + memberId + "/" + uuid, FILETYPE, brd.getImage());

        return new ResponseEntity<>(new BackgroundlessResponse(200, "Upload Success"), HttpStatus.OK);
    }
