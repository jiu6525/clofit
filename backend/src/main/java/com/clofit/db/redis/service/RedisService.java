...
public interface RedisService {
    ...
    void updateFitting(Long memberId, String redisId, String url) throws IOException;

    void removeFittingResult(Long memberId, String redisId) throws JsonProcessingException;
    List<String> getFittingList(Long memberId);
    FittingRecentResponse getFittingResult(String redisId) throws JsonProcessingException;
    boolean existFittingResult(Long memberId, String redisId) throws JsonProcessingException;
